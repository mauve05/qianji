<?php
/**
 * 潜记二维码作业登记系统（单用户版）- 数据库配置示例
 *
 * 推荐方式：浏览器访问 install.php 安装向导，会自动生成本文件（免手工编辑）。
 * 手工方式：将本文件复制为 db_config.php（同目录），并修改下方连接参数。
 * 注意：db_config.php 含真实密码，已被 .gitignore 排除，请勿提交到仓库。
 */
...
$db_user = 'root';
$db_pass = '你的数据库密码';
$db_name = 'qj_registration';   // 数据库名（install.php 会自动创建）
